...
% project = PROJECT
\newcommand{\doctitle}{Software Development Plan}
\newcommand{\project}{NumeriCube (transverse quality document)}
...
\input{chapters/02-hardware-architecture.tex}
\input{chapters/03-software-architecture.tex}
\input{chapters/04-software-requirements.tex}
...
% \input{annexes/01-dmake-user-manual.tex}
% \input{annexes/02-autodoc.tex}
\input{annexes/03-dataset-management.tex}
\input{annexes/04-must-read.tex}
\input{annexes/05-sample-snap7-session.tex}
